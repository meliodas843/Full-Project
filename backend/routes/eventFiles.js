...
async function sendWelcomeEmail({
  ...
  await setupTransporter.sendMail({
    ...
    subject: `"${eventTitle}" арга хэмжээнд таныг нэмлээ`,
    text: `Registra-д тавтай морилно уу\n\n` + `Сайн байна уу, ${name},\n\n` + `Таныг "${eventTitle}" арга хэмжээнд нэмлээ.\n\n` + `Таны бүртгэл амжилттай үүслээ.\n\n` + `Нууц үгээ тохируулах:\n${setupUrl}\n\n` + `Энэхүү холбоос 24 цагийн дараа хүчингүй болно.`, html: ` <div style=" max-width:560px; margin:0 auto; padding:32px; font-family:Arial,sans-serif; color:#172033; line-height:1.6; " > <h1 style=" margin:0 0 24px; font-size:26px; color:#172033; " > Registra-д тавтай морилно уу </h1> <p> Сайн байна уу, ${name}, </p> <p> Таныг <strong>"${eventTitle}"</strong> арга хэмжээнд нэмлээ. </p> <p> Таны бүртгэл амжилттай үүслээ. </p> <p> Registra бүртгэлдээ нэвтрэхийн тулд нууц үгээ тохируулна уу. </p> <div style=" margin:28px 0; " > <a href="${setupUrl}" style=" display:inline-block; padding:13px 24px; background:#6247ef; color:#ffffff; text-decoration:none; border-radius:10px; font-size:14px; font-weight:700; " > Нууц үг тохируулах </a> </div> <p style=" color:#667085; font-size:13px; " > Энэхүү холбоос 24 цагийн дараа хүчингүй болно. </p> <p style=" color:#667085; font-size:13px; " > Хэрэв дээрх товч ажиллахгүй бол доорх холбоосыг хуулж, хөтөч дээрээ оруулна уу: </p> <p style=" word-break:break-all; font-size:12px; color:#6247ef; " > ${setupUrl} </p> </div>
    `,
  });
